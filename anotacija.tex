...
Darbs sastāv no ievada, 4 nodaļām, secinājumiem un 5 pielikumiem. Tajā ir 51 lappuse, \totfig\ attēli, \tottab\ tabulas pamattekstā un \total{citenum} nosaukumi literatūras sarakstā.
...
\thispagestyle{empty}
	The work consists of introduction, 4 chapters, conclusions and 5 appendixes. It contains 51 pages, \totfig\ figures, \tottab\ tables and \total{citenum} references.
