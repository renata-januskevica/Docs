...
Maksimālās atmiņas izmantošanas problēma var notikt, kad iedalītu un atbrīvotu gabalu izmēru summa kaudzē sasniedz maksimumu procesa izpildes laikā.
Ir svarīgi pievērst uzmanību gadījumiem, kad var tikt sasniegta maksimālā atmiņas izmantošana.
Piemēram, tas var notikt, kad process tiecās pie trapa virsotnes vai maksimuma sasniegšanas.
Šeit ir iespējama situācija, kad liels atmiņas daudzums netiks atgriezts operētājsistēmai pēc izmantošanas, pat tad, ja atmiņa tiks atbrīvota ar free() vai delete palīdzību.
...
Pazīme, kas varētu liecināt par problēmas eksistenci ir pārmērīgs atmiņas patēriņš pēc maksimālās atmiņas izmantošanas.

Atmiņas izmetē pazīme, kas varētu liecināt par problēmas esamību, ir lielā izmēra atmiņas gabali, kuri atrodas bin sarakstos.
