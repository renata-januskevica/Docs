...
Šīs shēmas ir apkopotas balstoties uz kvantitatīvo programmu novērtējumu \cite{PWMS}. 
\begin{itemize}
...
Pazīme, kas varētu liecināt par problēmas esamību ir pārmērīgs atmiņas patēriņš pēc maksimālās atmiņas izmantošanas.
...
Tāds skaits, kurš varētu tikt izveidots sadalot mazākos gabalos procesa atmiņas patēriņa pieaugumu, kas notika mēģinot sasniegt trapa virsotni vai maksimuma punktu.
...
Pēc tam bija atbrīvoti 99 gabali izņemot pēdējo un tika uzģenerēta atmiņas izmete.
Saskaņā ar \cite{PWMS} pētījumu bija sasniegts maksimums (peaks). 
...
\end{lstlisting}
\caption{\textbf{\fontsize{11}{12}\selectfont {bin saraksta izdruka}}}
\end{figure}
%$
...
Tā kā 3 mazākie biti netiek izmantoti izmēra glabāšanai, bet kontroles bitiem, tad gabala izmērs ir 10138393 - 1=10138392.
Mūsu 99 atbrīvoto gabalu kopējais izmērs ir vienāds ar izmērs kilobaitos, kas ir sareizināts ar atbrīvoto gabalu skaitu, tātad 100*1024*99 = 10137600.
Atšķirība starp pirmā gabala izmēru bin sarakstā un atbrīvoto gabalu kopēju izmēru ir izskaidrojama ar izlīdzināšanu 8 - ka reizinājumam.
