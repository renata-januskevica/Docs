...
\section{Maksimālā atmiņas izmantošana}
Dinamiskās atmiņas daudzums, kas tiek izmantots programmas izpildes laikā visu laiku var mainīties.
Daudzām programmām var būt nepieciešams liels atmiņas daudzums, kāda uzdevuma paveikšanai, pēc kura pabeigšanas atmiņa tiks atbrīvota ar kādu no lietotāja atmiņās pārvaldības funkcijām.
Ir svarīgi pievērst uzmanību gadījumiem, kad izmantotās atmiņas daudzums kļūst uz laiku maksimāls\footnote{Maksimāls salīdzinot ar atmiņas daudzumu, kurš bija izmantots iepriekš.} (peak memory usage).



\subsection{Maksimālā atmiņas izmantošanas pazīmes}
