...
Ja programmā bija paredzēts, ka malloc() var atgriezt null, tad process turpina izpildi ierobežotā režīmā, jo vairs nav iespējams dinamiski iedalīt atmiņu. 
...
\section{Maksimālais kopējais kaudzes izlietojums}
 \label{sec:peak_mem}
Dinamiskās atmiņas daudzums, kas tiek izmantots programmas izpildes laikā visu laiku var mainīties.
Daudzām programmām var būt nepieciešams liels atmiņas daudzums, kāda uzdevuma izpildīšanai, pēc kura pabeigšanas atmiņa tiks atbrīvota ar kādu no lietotāja atmiņās pārvaldības funkcijām.
Ir svarīgi pievērst uzmanību gadījumiem, kad kopējais kaudzes izlietojums ir maksimāls\footnote{Maksimālais kopējais kaudzes izlietojums ir maksimālā kopējā iedalītu un atbrīvotu gabalu izmēru summa.} (peak memory usage).
Šajā brīdī ir iespējama situācija, kad liels atmiņas daudzums pēc izmantošanas netiks atgriezts operētājsistēmai, pat tad, ja tās būs atbrīvota ar free() vai delete palīdzību.
Rezultātā process var patērēt pārmērīgo atmiņas daudzumu, kurš netika paredzēts projektējumā.

Šī situācija kļūst iespējama, ja notiek daudzi pieprasījumi pēc atmiņas, kas ir mazāki par 128 kilobaitiem.
Pieprasījums pēc lielāka atmiņas gabala tiks apstrādāts ar mmap() sistēmas izsaukumu un neizraisīs doto problēmu.
Pēc mmap() izsaukumiem atmiņu ir iespējams atgriezt operētājsistēmai ar munmap() palīdzību. 
Bet, izmantojot brk() sistēmas izsaukumu, atmiņa var netikt atgriezta operētājsistēmai.
Tas ir atkarīgs no tā, kāda veidā tika atbrīvota atmiņa pēc maksimālā kopējā kaudzes izlietojuma sasniegšanas.
Kamēr netiks atbrīvota vislielākā adrese kaudzē, atmiņa netiks atgriezta operētājsistēmai.
...
\subsection{Maksimālā kopējā kaudzes izlietojuma pazīmes}
