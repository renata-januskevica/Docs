...
\begin{itemize}
    ...
    \item ir nepieciešams divreiz lielāks brīvas atmiņas apjoms nekā ir pieprasīts atkļūdojāmās programmas izpildei;
...
Ja tekošais gabals ir atbrīvots, tad tas jau ir pievienots vienam no bin sarakstiem un to nevajag apstrādāt.
Pēc tam, tiek nobīdīta norāde un pārbaudīts nākamais atmiņas gabals.
Tādā veidā tiek apstrādāti visi atmiņas gabali, kuri ir novietoti pirms top gabala sakot no kaudzes sākuma.
...
Gadījumos, kad norādes nav, tad dotais apgabals ir pazaudēts un tas var liecināt par atmiņas noplūdes problēmu.
...
Šīm nolūkam ir izmantota \texttt{od -t x} komanda, jo, atšķirībā no \texttt{xxd}, komanda ļauj bez baitu apgriešanas Intel x86 arhitektūrā iegūt korektas adreses, kuram  vismazāk nozīmīgākie baiti novietoti sākumā \cite{DPT}.
Atmiņas izmetes heksadecimalajā saturā tiek meklētas visas adreses, kurām jābūt atgrieztām programmai.
Kad adrese ir atrasta, tad tiek meklēta nākamā iedalīta adrese, ja nav atrasta, tad tiek atjaunināta pazaudēto gabalu statistika un izdrukāta atmiņas adrese.
Programmas izvads satur pazaudēto norāžu skaitu un pazaudēto atmiņas gabalu adreses (sk. 4.2. attēlu).
Iegūstot adreses atmiņas izmetē var apskatīties datus, kuri uzglabāti pazaudētājos gabalos un uzzināt atmiņas gabala izmēru.
Izmantojot doto informāciju, var identificēt objektu, kurš tika pazaudēts programmā.
...
Tā kā sniegtā izdruka atbilst programmas stāvoklim un programmā ir fiziska atmiņas noplūde, kuras rezultātā tiek pazaudēti 100 atmiņas gabali, tad tiek uzskatīts, ka dotās problēmas atkļūdošanai var izmantot atmiņas izmeti.
...
Informācija, kura tiek izdrukāta: skaits cik ir atbrīvoto gabalu sarakstā, amplitūda (mazākais gabals, lielākais gabals), kopējais gabalu izmērs sarakstā.
...
Dotā statistika rāda kopējo priekšstatu par programmas stāvokli.


Parauga fragmentēšanas programmai (sk. 3. pielikumu) tika padoti 2 argumenti 100, 100. 
...
Programmā tika atbrīvots katrs otrs atmiņas gabals 100 baitu izmērā. 
Tā kā sniegtā izdruka atbilst programmas stāvoklim,tad tiek uzskatīts, ka dotās problēmas atkļūdošanai var izmantot atmiņas izmeti.
