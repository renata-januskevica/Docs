Šajā nodalījumā ir aprakstīti atmiņas iedalīšanas paņēmieni, ir dots īss ieskāts atmiņas organizācijā un aprakstīta atmiņas pārvaldība, kuru var veikt kodols vai lietotājs.
Nodalījumā ir iekļauta informācija, kura palīdz saprast kopējo atmiņas organizācijas mehānismu un tās saistību ar programmu, ja programmā ir izmantota dinamiskā (kontrolētā) atmiņas iedalīšana. 
...
Ātrie gabali ir mazā izmērā (parasti līdz 64 baitiem) un pieder ātrajām sarakstām (fastbin), bet parastie gabali - parastajām sarakstam (normal bin). 
Abi saraksti sīkāk ir aprakstīti sadaļā 2.3.2.
Abu veidu atmiņas gabali: ātrie un parastie, tiek izmantoti, lai nodrošinātu atmiņas iedalīšanu.
...
Šos bitus izmanto kontroles zīmēm. Katram bitam ir sava nozīme, kura aprakstīta tabulā 2.2.
Sistēmas izsaukumu, mmap(), kas ir attēlots tabulā, izmanto, lai iegūtu atmiņas apgabalu, kas ir lielāks par 128 kilobaitiem. 
...
Last\_remainder ir dalījuma atlikums, kurš izveidojās pēc lielāka gabala sadalīšanas, lai apmierinātu pieprasījumu pēc maza gabala  \cite {BLACKHAT}.
 ...
 \subsection{Atbrīvotas atmiņas organizācija}
Realizācija ptmalloc2 ir masīvi, kuri uzglabā norādes uz bin sarakstiem.
...
Kad vairākiem pavedieniem ir nepieciešams vienlaicīgi iedalīt atmiņu no kaudzes un visi pavedieni mēģina piekļūt vienai un tai pašai arēnai, tad arēnas bloķēšana var būtiski samazināt veiktspēju.
...
GNU C bibliotēkā ir globāls \texttt{malloc\_state} objekts - globāla arēna, kura atšķiras ar to, kā atmiņu no kodola iegūst, izmantojot brk() (sk. 2.6. attēlu). 
Attēla izveidošanai tika izmantots GNU C malloc pirmkods \cite {MALLOC} un vietnē nopublicēta shēma \cite{AMM}. 
