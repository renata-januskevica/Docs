...
Turpmāk darbā, termins dinamiskā atmiņas iedalīšana apzīmē kontrolēto atmiņas iedalīšanu no kaudzes.
...
Lietotāja atmiņas pārvaldība ir realizēta veicot sistēmas izsaukumus un pārvaldot iegūtos gabalos.
Pārvaldīt nozīme: 
\begin{enumerate}
...
Sākot ar GNU C bibliotēkas 2.18 versiju, mazāko gabalu, kurš tiks iedalīts ar mmap(), nevis ar brk(), var uzdot ar M\_MMAP\_THRESHOLD konstanti.
