...
Atbrīvots atmiņas gabals, ja tas nebija iedalīts ar mmap() izsaukumu, netiek atgriezts operētājsistēmai, bet ir defragmentēts vai sapludināts ar pārējiem gabaliem un ievietots sarakstā. 
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.29]{fastbins}
\end{center}
