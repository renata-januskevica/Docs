...
Taču tas nav vienīgais veids, ka var iegūt atmiņas izmeti, eksistē vairākas iespējas kā to var uzģenerēt patstāvīgi.  To var izdarīt no programmas koda,  gdb atkļūdotāja vai komandrindas interpretatora. 
...
Lai darbotos ar atmiņas izmetēm ir nepieciešams, lai rīks, kurš tika izvēlēts (bibliotēka, utilītprogramma vai atkļūdotājs) atbalstītu uzģenerētās datnes formātu.
...
Lai izdrukātu atmiņas apgabalu var izmantot sekojošo formātu: \texttt{(gdb) x/nfu addr}. 
...
Izmantojot doto piemēru (sk. 1.7. attēlu) tiks izdrukāti 4 elementi, kuri sākas ar rādītāju uz steku, Intel x86 procesoros 32 bitu režīmā uz steku norāda \$esp reģistrs. 
Formātu un vienības lielumu vajag norādīt saskaņā ar gdb pamācību \cite{gdb}. 
Dotajā gadījumā atmiņa tiks izdrukāta heksadecimālā formātā (x), vienības lielums ir vārds (word) jeb 4 baiti.
\begin{figure}[h]
\begin{lstlisting}
(gdb) x/4wx $esp
\end{lstlisting}
...
Instrukcija \texttt{print} vai \texttt{p} ļauj izdrukāt datus, bet \texttt{p/a} izdrukā absolūto un relatīvo (adresi ar nobīdi) no tuvāka simbola, kuram pieder adrese.
Tādā veidā var noteikt kuram atmiņas apgabalam pieder nezināma adrese.
Gdb atbalsta tipu pārveidošanu, tāpēc adresi var interpretēt ka norādi, kas ļauj ērti apskatīt dažādas struktūras un tās elementus.
\begin{figure}[h]
\begin{lstlisting}
(gdb) p/a 0x54320
...
Backrtace var nesniegt patieso informāciju par funkciju, kas bija izpildītā pēdējā, jo procesu var pabeigt ārējo apstākļu dēļ, nevis iekšējās koda kļūdas dēļ.
