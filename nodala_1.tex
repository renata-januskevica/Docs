...
Taču tas nav vienīgais veids, ka var iegūt atmiņas izmeti, eksistē vairākas iespējas kā to var uzģenerēt patstāvīgi, lai veiktu programmas atkļūdošanu.
To var izdarīt no programmas koda,  gdb atkļūdotāja vai komandrindas interpretatora. 
...
Tā kā segmentu robežas ir zināmas, tad kļūst iespējams izdrukāt atmiņas saturu, kas pieder segmentiem un uzzināt kuram segmentam pieder konkrētā atmiņas adrese.
...
Instrukcija \texttt{print} vai \texttt{p} ļauj izdrukāt datus, bet \texttt{p/a} izdrukā absolūto un relatīvo jeb adresi ar nobīdi no tuvāka simbola, kuram pieder adrese.
