...
Tādas kļūdas kā dalīšana ar nulli nosūta SIGFPE signālu, bet vēršanās pēc null radītāja - SIGSEGV signālu.
...
Lai izdrukātu atmiņas apgabalu var izmantot instrukciju ar sekojošo formātu: \texttt{(gdb) x/nfu addr}. 
...
Backrtace var nesniegt patieso informāciju par funkciju, kas bija izpildītā pēdējā, jo procesu var pabeigt ārējo apstākļu dēļ, nevis tāpēc, ka bija notikusi iekšējā kļūda.
