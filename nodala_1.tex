Šajā nodaļa tiek aplūkots atmiņas izmetes jēdziens, atmiņas izmetes ģenerēšanas iespējas un nosacījumi.
...
\end{itemize} 
 ...
 Šīs posms nav pietiekoši labi izpētīts literatūrā. Bet pirms sākt atkļudošanu ir nepieciešams pārliecināties, ka atmiņas izmete var tikt pielietota šīm nolūkam.
 ...
 Gadījumos, kad atmiņas izmete tiek nogriezta, tad tiks izvadīts brīdinājums par to, ka datnes izmērs neatbilst sagaidāmam.
