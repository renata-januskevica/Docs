...
Uz aprakstītiem pamatjēdzieniem, turpmāk tiks balstīta kaudzes atkļūdošanas metode.
...
Nospiežot Control + $\backslash$ tiks nosūtīts SIGQUIT signāls procesam, kas pašreiz ir palaists (sk. 1.4. attēls) \cite {nosacijumi}. 
...
Lai darbotos ar atmiņas izmetēm ir nepieciešams, lai rīks, kurš tika izvēlēts (bibliotēka, utilītprogramma vai atkļūdotājs) atbalstītu ELF formāta failus.
...
Ja atmiņas izmete neiekļauj atkļūdošanas informāciju, tad atmiņas izmete var attēlot sekojošo tekstu (sk. 1.5. attēls).
...
Tā kā segmentu robežas ir zināmas, tad kļūst iespējams izdrukāt atmiņas saturu, kas pieder segmentiem, uzzināt kuram segmentam pieder konkrētā atmiņas adrese un kādas ir tās vērtības.

Lai izdrukātu atmiņas apgabalu ir nepieciešams norādīt atmiņas adresi (\texttt{addr}), no kura sākt atmiņas izdruku, formātu (\texttt{f}), apgabala lielumu (\texttt{n}) un norādīt vienības lielumu (\texttt{u}) (sk. 1.7. attēls). 
...
CPU reģistru vērtības ir iespējams iegūt, izmantojot komandu \texttt{info registers} vai \texttt{i r} (sk. 1.8. attēls). 
...
edx     x8       8
ebx     0x2377   9079
esp     0xbf97a254     0xbf97a254
ebp     0xbf97a298     0xbf97a298
esi     0x0      0
edi     0xb77abff4     -1216692236
...
gs      0x33     51
\end{lstlisting}
\caption{\textbf{\fontsize{11}{12}\selectfont {Atmiņas izmetes CPU reģistri 32 bitu, Intel x86 arhitektūrā}}}
\end{figure}
